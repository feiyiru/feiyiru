...
## Extract from:
\qquad Bradley Efron and Trevor Hastie  

\qquad $Computer Age Statistical Inference: Algorithms, Evidence, and Data Science$  

\qquad $Cambridge University Press, 2016$  

\qquad $https://web.stanford.edu/~hastie/CASI_files/PDF/casi.pdf$
\newline 
\newline
\newline
\newline
